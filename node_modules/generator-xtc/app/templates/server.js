...
app.locals({ xtcVersion: cfg.get('xtcVersion') });
...
app.xtc.registerProjectMiddlewares(function(express) {
	...
	//app.use(express.multipart());         // Security tip: leave disabled if you don't need file upload.
...
require(path.join(cfg.get('appPath'), '/lib/handlebars-helpers.js'))(app.xtc.handlebars);

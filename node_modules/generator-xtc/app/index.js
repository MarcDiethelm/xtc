...
var XtcGenerator = module.exports = function XtcGenerator(args, options, config) {
	...
	// store setup config in here for setting defaults when running setup again or updating
	this.rc = {
		 rcVersion  : 0
	...
	log(intro, _projectJson.dependencies.xtc);
};
...
function onEnd() {
	...
	var outro =
		...
		chalk.cyan('xtc help')      +'\t\tlist available commends\n\n'

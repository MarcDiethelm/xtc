module.exports = function(cfg) {
	...
	var  handlebars = require('express3-handlebars').create({}).handlebars
		...
		,path = require('path')
		,_ = require('lodash')
		,handlebarsHelpers = require('./helpers-handlebars.js')(cfg)
		,utils = require('./utils')
	...
	// This module's Handlebars instance needs to know about the mod helper too, so modules can be nested.
	handlebars.registerHelper('mod', modHelper);
	handlebars.registerHelper('log', handlebarsHelpers.log);
	handlebars.registerHelper('env', handlebarsHelpers.env);
	handlebars.registerHelper('filler', handlebarsHelpers.filler);


	evaluateDataAttr = function(dataAttr, args, hash) {

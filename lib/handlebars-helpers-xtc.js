var  handlebars = require('handlebars')
	...
	,testTemplate
	,helpers = {}
	,userHelpersFile = process.env.testRun || process.env.xtcDev
		? path.join(cfg.appPath, '/node_modules/generator-xtc/app/templates/_lib/handlebars-helpers.js')
		: path.join(cfg.appPath, '/lib/handlebars-helpers.js')
;

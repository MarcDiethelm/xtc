...
cssUri = cfg.buildUriPrefix + cfg.static.build.css.external[NODE_ENV];
jsUri  = cfg.buildUriPrefix + cfg.static.build.js.external[NODE_ENV];
...
module.exports.makeLocals = function() {
	...
	return {
		...
		,'static': {
			...
			,build: {
				js: {
					external: cfg.buildUriPrefix + cfg.static.build.js.external[NODE_ENV]
				}
				,css: {
					external: cfg.buildUriPrefix + cfg.static.build.css.external[NODE_ENV]
				}
			}
		}
